...
//  glViewport (0, 0, ample, alt);
  ...
  modelTransform (glm::vec3(2, 0, 2), glm::vec3(0, 1, 0), 0);
  ...
  // Carreguem la transformació de model
  modelTransform (glm::vec3(0, 0, 0), glm::vec3(0, 1, 0), float(M_PI)/2);
  ...
  // Carreguem la transformació de model
  modelTransform (glm::vec3(-2.0, 0, -2.0), glm::vec3(0, 1, 0), float(M_PI));
...
void MyGLWidget::modelTransform (glm::vec3 pos, glm::vec3 rot_vec, float angle)
{
  ...
  transform = glm::rotate(transform, angle, rot_vec);
