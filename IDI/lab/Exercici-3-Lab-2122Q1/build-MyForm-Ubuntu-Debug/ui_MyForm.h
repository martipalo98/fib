...
public:
    ...
    QLabel *label_velocitat;
    QHBoxLayout *horizontalLayout_7;
    QLabel *label_velocitat0;
    QSlider *sliderSPD;
    QLabel *label_velocitat1000;
...
""));
        ...
        label_velocitat = new QLabel(MyForm);
        label_velocitat->setObjectName(QString::fromUtf8("label_velocitat"));

        verticalLayout_6->addWidget(label_velocitat, 0, Qt::AlignHCenter|Qt::AlignVCenter);

        horizontalLayout_7 = new QHBoxLayout();
        horizontalLayout_7->setObjectName(QString::fromUtf8("horizontalLayout_7"));
        label_velocitat0 = new QLabel(MyForm);
        label_velocitat0->setObjectName(QString::fromUtf8("label_velocitat0"));

        horizontalLayout_7->addWidget(label_velocitat0, 0, Qt::AlignRight);

        sliderSPD = new QSlider(MyForm);
        sliderSPD->setObjectName(QString::fromUtf8("sliderSPD"));
        sliderSPD->setMinimum(1);
        sliderSPD->setMaximum(259);
        sliderSPD->setSingleStep(50);
        sliderSPD->setTracking(true);
        sliderSPD->setOrientation(Qt::Horizontal);
        sliderSPD->setInvertedAppearance(false);

        horizontalLayout_7->addWidget(sliderSPD);

        label_velocitat1000 = new QLabel(MyForm);
        label_velocitat1000->setObjectName(QString::fromUtf8("label_velocitat1000"));

        horizontalLayout_7->addWidget(label_velocitat1000, 0, Qt::AlignLeft);
        ...
        verticalLayout_3->addWidget(quantesBoles, 0, Qt::AlignHCenter|Qt::AlignVCenter);
        ...
        verticalLayout_3->addWidget(botoAfegir, 0, Qt::AlignHCenter|Qt::AlignVCenter);
        ...
        QObject::connect(sliderSPD, SIGNAL(sliderReleased()), MyForm, SLOT(afegirBoles()));
    ...
    void retranslateUi(QWidget *MyForm)
    {
        ...
        label_velocitat->setText(QApplication::translate("MyForm", "<html><head/><body><p align=\"center\">velocitat:</p></body></html>", nullptr));
        label_velocitat0->setText(QApplication::translate("MyForm", "0", nullptr));
        label_velocitat1000->setText(QApplication::translate("MyForm", "250", nullptr));
